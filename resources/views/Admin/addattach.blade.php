...
<div class="admin">
    <div class="panel admin-panel margin-top">
        ...
        <div class="body-content">
            <form method="post" class="form-x" action="{{route('attach.store',['article'=>$article])}}" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <textarea id="desc" name='desc' type="text/plain" style="width:980px;height:350px;"></textarea>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <ul class="dowebok">
                            <li><input type="checkbox"  name="is_sale" data-labelauty="购买" ></li>
                        </ul>
                    </div>
                </div>
